...
PROJECT_NAME=just_flying_trajectory_tracking
...
'
  'Trajectory' 'waitForHw; history -s rosservice call /'"$UAV_NAME"'/control_manager/eland; history -s rosservice call /'"$UAV_NAME"'/control_manager/start_trajectory_tracking; history -s ./config/square_path.sh
'
