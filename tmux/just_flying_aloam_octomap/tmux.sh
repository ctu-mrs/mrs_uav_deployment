...
'
  'Ouster' 'waitForTime; roslaunch ouster_ros uav.launch
'
  'Aloam' 'waitForRos; roslaunch mrs_aloam_core slam_pipeline.launch
'
  'Octomap' 'waitForTime; roslaunch mrs_octomap_mapping_planning mapplan.launch config_octomap_server:=./config/octomap_server.yaml config_octomap_planner:=./config/octomap_planner.yaml config_pcl_filter_ouster:=./config/ouster_filter_mapping.yaml world_frame_id:='"$UAV_NAME"'/slam_origin
'
